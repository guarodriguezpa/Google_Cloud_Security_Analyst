n this capstone project, I worked as a junior cloud security analyst at
...
1.  In the Google Cloud console, in the **Navigation
    ...
    height="0.1388888888888889in"}), click **Security \> Risk
    Overview**. The Security Command Center Overview page opens.

![](media/image2.png){width="7.147688101487314in"
height="3.8263484251968505in"}
...
![](media/image3.png){width="5.896386701662292in"
height="4.128945756780403in"}
...
![](media/image4.png){width="7.3572583114610675in"
height="5.823210848643919in"}
...
![](media/image5.png){width="7.273821084864392in"
height="4.038384733158355in"}

![](media/image6.png){width="7.245363079615048in"
height="3.970310586176728in"}
...
![](media/image7.png){width="6.212055993000875in"
height="4.563214129483814in"}
...
![](media/image8.png){width="6.912968066491689in"
height="4.492040682414698in"}
...
![](media/image9.png){width="7.139542869641295in"
height="2.7699978127734033in"}
...
7.  In the Google Cloud console, in the **Navigation
    menu** (![navigation_menu](media/image1.png){width="0.15625in"
    height="0.1388888888888889in"}), click **Security \> Findings**.
...
![](media/image10.png){width="7.11494750656168in"
height="4.608068678915136in"}
...
![](media/image11.png){width="6.4995811461067365in"
height="5.709803149606299in"}
...
![](media/image12.png){width="7.3137992125984255in"
height="5.385617891513561in"}
...
Now that you have analyzed the security vulnerabilities, it's time to
